 ...
 * <p>Key components:
 * <ul>
 * <li>{@link com.luchersol.core.util.AbstractChecker} - Base class for all checker implementations</li>
 * <li>{@link com.luchersol.core.util.MessageService} - Internationalized message management</li>
